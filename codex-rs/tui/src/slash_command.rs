...
impl SlashCommand {
    ...
    pub fn description(self) -> &'static str {
        match self {
            ...
            SlashCommand::DesktopPet => "toggle the desktop pet overlay",
...
mod tests {
    ...
    fn pet_alias_parses_to_pets_command() {
        ...
        assert_eq!(SlashCommand::DesktopPet.command(), "pet");
        assert_eq!(SlashCommand::from_str("pet"), Ok(SlashCommand::DesktopPet));
    }
